...
>
> **Stale-unchecked examples in this file:** **T3.1–T3.6** all shipped despite their
> boxes being unticked. Read them as done unless the debt register says otherwise.
