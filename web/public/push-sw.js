// Web push service-worker handlers.
//
...
// as-is. That is also why the decision logic is factored into PURE functions
// exposed on `self.__pushSw`: no bundler means no import, so the unit tests
// evaluate this source in a fake scope and call them directly.
