...
// Extracted in fase B2 T10 (see `components/issues/reply-composer.tsx`) so the
// issue surface can reply to an agent without importing this page-only card.
// Re-exported below for the page's own import sites during the removal.
