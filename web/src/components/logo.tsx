...
export function Logo({ className, title = 'supermux' }: LogoProps) {
  ...
  return (
    ...
    >
      ...
      {/* Horizontal mirror around the viewBox's horizontal centre (x=531):
          2 * 531 = 1062 → translate(1062 0) scale(-1 1). Keeps the chevrons
          in-place within the same viewBox; just flips left↔right. Master SVG,
          icon.svg, favicon.svg, and src/brand/logo.svg use the same wrap. */}
      <g transform="translate(1062 0) scale(-1 1)">
